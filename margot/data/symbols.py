...
class Symbol(object):
    ...
    def __init__(self, symbol: str, env:dict={}):
        ...
        self.symbol = symbol
        self.env = env
        self.fields = [member for member, ref in getmembers(self) if isinstance(ref, BaseField)]
        self.features = [member for member, ref in getmembers(self) if isinstance(ref, BaseColumn)]
